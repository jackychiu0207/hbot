        ...
        if data["dbfId"]==int(dict(interaction.data)['custom_id']):
            if "audio" in data:
                for name in data["audio"]:
                    if "BASIC_PLAY" == name.upper():options.append(SelectOption(label="入場",description=name,value=",".join(data["audio"]["BASIC_play"])))
                    elif "BASIC_ATTACK" == name.upper():options.append(SelectOption(label="攻擊",description=name,value=",".join(data["audio"]["BASIC_attack"])))
                    elif "BASIC_DEATH" == name.upper():options.append(SelectOption(label="死亡",description=name,value=",".join(data["audio"]["BASIC_death"])))
                    elif "CONCEDE" in name.upper():options.append(SelectOption(label="投降",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_FULL_MINIONS" in name.upper():options.append(SelectOption(label="滿場",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_GENERIC" in name.upper():options.append(SelectOption(label="無法這麼做",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_HAND_FULL" in name.upper():options.append(SelectOption(label="爆牌",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_I_ATTACKED" in name.upper():options.append(SelectOption(label="我已經攻擊過了",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_JUST_PLAYED" in name.upper():options.append(SelectOption(label="手下還不能攻擊",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_MINION_ATTACKED" in name.upper():options.append(SelectOption(label="手下已經攻擊過了",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_NEED_MANA" in name.upper():options.append(SelectOption(label="我需要法力",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_NEED_WEAPON" in name.upper():options.append(SelectOption(label="我需要武器",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_PLAY" in name.upper():options.append(SelectOption(label="我無法打出這張牌",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_STEALTH" in name.upper():options.append(SelectOption(label="我無法指定潛行的目標",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_TARGET" in name.upper():options.append(SelectOption(label="我無法指定那個目標",description=name,value=",".join(data["audio"][name])))
                    elif "ERROR_TAUNT" in name.upper():options.append(SelectOption(label="必須先攻擊有嘲諷的手下",description=name,value=",".join(data["audio"][name])))
                    elif "FIRE_FESTIVAL" in name.upper():options.append(SelectOption(label="仲夏火焰節快樂",description=name,value=",".join(data["audio"][name])))
                    elif "LUNAR_NEW_YEAR" in name.upper():options.append(SelectOption(label="新春愉快",description=name,value=",".join(data["audio"][name])))
                    elif "GREETINGS_RESPONSE" in name.upper():options.append(SelectOption(label="你好(鏡像)",description=name,value=",".join(data["audio"][name])))
                    elif "GREETINGS" in name.upper():options.append(SelectOption(label="你好",description=name,value=",".join(data["audio"][name])))
                    elif "HALLOWS_END" in name.upper():options.append(SelectOption(label="萬鬼節快樂",description=name,value=",".join(data["audio"][name])))
                    elif "LOW_CARDS" in name.upper():options.append(SelectOption(label="我快沒有牌了",description=name,value=",".join(data["audio"][name])))
                    elif "MIRROR_START" in name.upper():options.append(SelectOption(label="開場(鏡像)",description=name,value=",".join(data["audio"][name])))
                    elif "NOBLEGARDEN" in name.upper():options.append(SelectOption(label="歡慶貴族花園節",description=name,value=",".join(data["audio"][name])))
                    elif "NO_CARDS" in name.upper():options.append(SelectOption(label="我沒有牌了",description=name,value=",".join(data["audio"][name])))
                    elif "OOPS" in name.upper():options.append(SelectOption(label="唉呀",description=name,value=",".join(data["audio"][name])))
                    elif "PIRATE_DAY" in name.upper():options.append(SelectOption(label="海盜節快樂",description=name,value=",".join(data["audio"][name])))
                    elif "SORRY" in name.upper():options.append(SelectOption(label="抱歉",description=name,value=",".join(data["audio"][name])))
                    elif "START" in name.upper():options.append(SelectOption(label="開場",description=name,value=",".join(data["audio"][name])))
                    elif "THANKS" in name.upper():options.append(SelectOption(label="謝謝",description=name,value=",".join(data["audio"][name])))
                    elif "THINK1" in name.upper():options.append(SelectOption(label="思考1",description=name,value=",".join(data["audio"][name])))
                    elif "THINK2" in name.upper():options.append(SelectOption(label="思考2",description=name,value=",".join(data["audio"][name])))
                    elif "THINK3" in name.upper():options.append(SelectOption(label="思考3",description=name,value=",".join(data["audio"][name])))
                    elif "THREATEN" in name.upper():options.append(SelectOption(label="威脅",description=name,value=",".join(data["audio"][name])))
                    elif "TIMER" in name.upper():options.append(SelectOption(label="時間快不夠了",description=name,value=",".join(data["audio"][name])))
                    elif "WELL_PLAYED" in name.upper():options.append(SelectOption(label="玩得不錯",description=name,value=",".join(data["audio"][name])))
                    elif "WINTERVEIL_GREETINGS" in name.upper():options.append(SelectOption(label="冬幕節快樂",description=name,value=",".join(data["audio"][name])))
                    elif "WOW" in name.upper():options.append(SelectOption(label="厲害",description=name,value=",".join(data["audio"][name])))
                    elif "YEAR" in name.upper():options.append(SelectOption(label="新年快樂",description=name,value=",".join(data["audio"][name])))
